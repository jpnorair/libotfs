About multifs_posix:
multifs_posix is a null application for OpenTag, for the purpose of compiling 
certain components of OpenTag onto POSIX clients.  The "multifs" specfies that
it is designed to access multiple OpenTag [Veelite] filesystems.
